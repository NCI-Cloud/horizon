...
$.extend(horizon.membership, {
  ...
  generate_html: function(step_slug) {
    ...
    // potentially lots of elements to.
  ...
  update_membership: function(step_slug) {
    ...
    // Add new member to the default role.
    $("#" + step_slug + "_add_member_btn").click(function(evt) {
      evt.preventDefault();
      var add_member_select = $("#" + step_slug + "_add_member_select");
      ...
      if (data_id) {
        ...
        $("." + step_slug + "_members").append(horizon.membership.generate_member_element(step_slug, display_name, data_id, [default_role], "-"));
    ...
    $("." + step_slug + "_members").on("click", ".btn-group a[href='#add_remove']", function(evt) {
      evt.preventDefault();
